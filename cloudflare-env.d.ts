/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 24c63ceb9514d4604804376fe2754f4f)
// Runtime types generated with workerd@1.20260804.1 2026-08-03 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	CONTACT_ALLOWED_HOSTNAME: "yushko.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_ALLOWED_HOSTNAME" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY">> {}
}
